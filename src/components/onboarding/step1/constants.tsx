...
export type StoryIdeaFieldKey = Exclude<keyof StoryIdeaCard, 'id' | 'title'>
...
export const CARD_FIELD_ICONS: Record<StoryIdeaFieldKey, React.ReactNode> = {
...
export const CARD_FIELD_LABELS: Record<StoryIdeaFieldKey, string> = {
  genre: '题材',
  worldBuilding: '世界观',
  protagonist: '主角',
  coreConflict: '核心冲突',
...
export const CARD_FIELD_ORDER: StoryIdeaFieldKey[] = [
  'genre',
  'worldBuilding',
  'protagonist',
  'coreConflict',
